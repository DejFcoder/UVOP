...
function Profile() {
  return (
    <Layout>
      ...
      <div className="lg:grid items-center lg:grid-cols-7 flex flex-col mt-4 border-2 border-black rounded-lg p-4 gap-4 font-medium hover:bg-blue-200 transition-all duration-200 ease-linear">
